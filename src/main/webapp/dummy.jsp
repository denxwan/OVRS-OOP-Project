...
<body class="d-flex flex-column h-100">
	...
	<div class="text-center">
        ...
        <div><button class="basic-btn" id="write">Write a review</button></div>
        <br>
    </div>
	...
	<div class="r-container">
		<div class="r-container-1">
			<label class="r-label-h">Haritha Denuwan</label><br>
			<label class="r-label" style="color: grey">harithadenuwan@gmail.com</label>
			<div class="r-container-2">
				<label class="r-label-c">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tellus felis, posuere imperdiet eros ut, pulvinar vulputate nisl. Nunc scelerisque efficitur nisi, eget interdum nibh. In eget tellus bibendum, interdum lorem at, fermentum nisi.</label>
			</div>
		</div>
	</div>
	...
	<div class="r-container">
		<div class="r-container-1">
			<label class="r-label">Haritha Denuwan</label><br>
			<label class="r-label">harithadenuwan@gmail.com</label>
		</div>
	</div>

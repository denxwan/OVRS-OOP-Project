...
<!--              	 </li> -->
    ...
    <div class="text-center">
        <label style="margin-bottom: -200px;" class="title-1">Review Dashboard</label><br>
        <label class="title-2">All of your reviews made on this website are here for you to modify</label>
        <div>
<!--         	<button onclick="window.location='writeReviews.jsp';" class="basic-btn" id="write">Write a review</button> -->
				<div style="display:flex; justify-content:center; flex-wrap:wrap;">
				<form action="ewreview" method="post">
					<c:forEach var="vr" items="${reviewDetails}">
						<input hidden type="text" name="name" class="form-dropdown" value="${vr.rname}" readonly>
						<input hidden type="text" name="email" class="form-dropdown" value="${vr.remail}" readonly>
					</c:forEach>
					<button type="submit" class="basic-btn">Write a new review</button>
				</form>
				
				<form action="vreview" method="post">
					<button type="submit" class="basic-btn">Check all reviews</button>
				</form>
				</div>
        </div>
        <br>
	...
	<div class="r-container">
		<div class="r-container-1">
			<label class="r-label-h">${vr.rname}</label>
			<div style="margin-left: 505px; margin-top: -75px; display:flex; justify-content:center; flex-wrap:wrap;">
			<form action="redit" method="post">
				<input hidden type="text" name="name" class="form-dropdown" value="${vr.rname}" readonly>
				<input hidden type="text" name="email" class="form-dropdown" value="${vr.remail}" readonly>
				<input hidden type="text" name="rid" value="${vr.rid}" readonly>
				<input hidden type="text" name="comment" class="form-dropdown" value="${vr.rcomment}" readonly>
				<button type="submit" class="basic-btn">Edit</button>
			</form>
			<form action="rdelete" method="post" id="delete-form">
				<input hidden type="text" name="name" class="form-dropdown" value="${vr.rname}" readonly>
				<input hidden type="text" name="email" class="form-dropdown" value="${vr.remail}" readonly>
				<input hidden type="text" name="rid" value="${vr.rid}" readonly>
				<button type="submit" class="basic-btn">Delete</button>
			</form>
			</div>
    ...
    <script>
//    		document.getElementById("rc").value = "${vr.rcomment}";

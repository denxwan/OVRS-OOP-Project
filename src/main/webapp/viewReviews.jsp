...
<!-- 	Previous Method, changing it to have a servlet and get the usernames in the database -->
...
<!--     </div> -->
		...
		<form action="getUser" method="post">
			<div class="text-center">
        		...
        		<label class="title-2">You can write your own experience with our services</label>
       		<div>
				<button type="submit" class="basic-btn">Write a review</button>
        	</div>
        </form>
	...
	<div class="r-container">
		<div class="r-container-1">
			...
			<label hidden class="r-label" style="color: grey">${vr.remail}</label>

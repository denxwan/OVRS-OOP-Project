...
<!--              	 </li> -->
    ...
    <div class="text-center">
        <label style="margin-bottom: -200px;" class="title-1">Search, Compare & Reserve</label><br>
    ...
    <div class="form-container">
        <div class="form-buttons">
                ...
                <button class="basic-btn" onclick="buttonActiveSD()" id="sd">Self Drive</button>
                <button class="basic-btn" onclick="buttonActivePD()" id="pd">Pickup (with driver)</button>
                <button class="basic-btn" onclick="buttonActiveAP()" id="ap">Airport Pickup</button>
                <button class="basic-btn" onclick="buttonActiveWD()" id="wd">Wedding / VIP</button>
...
<!--             <div class="form-dynamic-1"> -->
<!--                 <div><label class="form-label">Select your pickup date & time</label></div> -->
<!--                 <div><input class="form-dropdown-1" type="date"><label>&emsp;</label> -->
<!--                 <input class="form-dropdown-1" type="time"></div> -->
<!--             </div> -->

<!--             <div class="form-dynamic-1"> -->
<!--                 <div><label class="form-label">Select your return date & time</label></div> -->
<!--                 <div><input class="form-dropdown-1" type="date"><label>&emsp;</label> -->
<!--                 <input class="form-dropdown-1" type="time"></div> -->
<!--             </div> -->

<!--             <div class="form-dynamic-1"> -->
<!--                 <div><label class="form-label">Driver is older than 25?</label>&emsp; -->
<!--                 <label class="title-3">Yes</label>&ensp;<input type="radio" name="old" id="yes">&emsp; -->
<!--                 <label class="title-3">No</label>&ensp;<input name="old" type="radio" id="no"> -->
<!--                 </div> -->
...
<!--             </div> -->
				...
				<div class="form-dynamic-1">
                	<div><label class="form-label">Select trip type : </label></div>
                	<div><select name="tripType" id="tt" class="form-dropdown">
                    	<option value="ap">Airport Pickup</option>
                    	<option value="pp">Normal Pickup</option>
                    	<option value="sd">Self Drive</option>
                	</select></div>
            	</div>
            	
            	<div class="form-dynamic-1">
                	<div><label class="form-label">Select number of passenger/s : </label></div>
                	<div><select name="nofp" id="nop" class="form-dropdown">
				...
				<div class="form-dynamic-1">
					<div><button class="basic-btn" type="submit" name="submit">Show Offers</button></div>
				</div>

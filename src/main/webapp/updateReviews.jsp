...
<!--              	 </li> -->
    ...
    <div class="text-center">
        <label style="margin-bottom: -200px;" class="title-1">Edit your review</label><br>
        <label class="title-2">Edit your previously entered review in our website</label>
    </div>
    ...
    <div class="form-container">
        ...
        <div class="form-dynamic" style="justify-content: center;">
				...
				<form action="ureview" method="post">
				
				<c:forEach var="tempUser" items="${reviewDetails}">
				<div style="justify-content: center;">
				<div class="form-dynamic-1">
                	<div><label class="form-label">Your name : </label></div>
                	<div><input type="text" name="name" class="form-dropdown" value="${tempUser.rname}" readonly></div>
            	</div>
            	
            	<div class="form-dynamic-1">
                	<div><label class="form-label">Your email address : </label></div>
                	<div><input type="text" name="email" class="form-dropdown" value="${tempUser.remail}" readonly></div>
            	</div>
       			
            	<div class="form-dynamic-1">
            		<input hidden type="text" name="rid" value="${tempUser.rid}" readonly>
                	<div><label class="form-label">Edit your review : </label></div>
                	<div><textarea id="rc" rows="3" cols="30" name="comment" onkeyup="checkCount()" style="border-bottom-color: #ff6127; border-bottom-width: 5px;" required></textarea>
            	</div>
            	</div>
				...
				<div class="form-dynamic-1" style="padding-top: -20px; background-color: lightgrey">
					<div>
						...
						<label class="form-label" id="count">...</label><br>
				...
				<div class="form-dynamic-1">
					<div style="display: flex; justify-content: center;"><button id="btn"  class="basic-btn" type="submit" name="submit">Update your review</button></div>
				</div>
    ...
    <c:forEach var="tempUser" items="${reviewDetails}">
    <script>
    	document.getElementById("rc").value = "${tempUser.rcomment}";
    	...
    	function checkCount() {
			var max = 200;
			var count = document.getElementById("rc").value.length;

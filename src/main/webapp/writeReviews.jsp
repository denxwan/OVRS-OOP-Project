...
<!--             </div> -->
				...
				<form action="wreview" method="post">
				
				<c:forEach var="tempUser" items="${reviewDetails}">
				
				<div class="form-dynamic-1">
                	<div><label class="form-label">Your name : </label></div>
                	<div><input type="text" name="name" class="form-dropdown" placeholder="Type here..."  value="${tempUser.rname}" readonly></div>
            	</div>
            	
            	<div class="form-dynamic-1">
                	<div><label class="form-label">Your email address : </label></div>
                	<div><input type="text" name="email" class="form-dropdown" placeholder="Type here..." value="${tempUser.remail}" readonly></div>
            	</div>
            	...
            	<div class="form-dynamic-1">
                	...
                	<div><textarea id="cmt" name="comment" autofocus="autofocus" onkeyup="checkCount()" class="form-dropdown" placeholder="Type here..." required></textarea></div>
            	</div>
				<div style="width:410px">
				<div class="form-dynamic-1" style="padding-top: -20px; background-color: lightgrey">
					<div>
						<label class="form-label">Number of characters left : </label>
						<label class="form-label" id="count">200</label><br>
						<label id="hidden" hidden>You're exceeding the maximum character limit. Please try to reduce your comment.</label>
					</div>
				</div>
				</div>
				
				<div class="form-dynamic-1" style="align-items:center">
					<div><button class="basic-btn" type="submit" id="btn" name="submit">Submit your review</button></div>
				</div>
...
//     	}
		...
		function checkCount() {
			var max = 200;
			var count = document.getElementById("cmt").value.length;
			var leftCount = max-count;
			document.getElementById("count").innerHTML = leftCount;
